							...
							L5: do {
								F.line = 186;
									...
									if (!(i_203502 < l_203503)) break L6;
										...
										F.line = 189;
										failed_assert_impl_56866(makeNimstrLit("/home/travis/build/nim-lang/Nim/lib/system/iterators.nim(189, 11) `len(a) == L` the length of the seq changed while iterating over it"));
										}
